...
data = dict(
    ...
    val=dict(
        ...
        lq_folder='/content/drive/MyDrive/1THESIS/val/val_sharp_bicubic/X4',
        gt_folder='/content/drive/MyDrive/1THESIS/val/val_sharp',
...
evaluation = dict(interval=310000, save_image=False, gpu_collect=True)
